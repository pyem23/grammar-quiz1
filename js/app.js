...
class GrammarQuizApp {
        ...
        <div class="dashboard">
          ...
          <div class="dashboard-main">
            <div class="card">
              ...
              <div class="card-body">
                <p>Pilih topik di samping untuk memulai kuis. Setiap topik memiliki 10-20 pertanyaan.</p>
  ...
  saveScore(scoreData) {
    ...
    this.saveScoresToStorage();
    // Send to Google Sheets (permanent storage)
    this.sendToGoogleSheets(scoreData);
  }

  sendToGoogleSheets(scoreData) {
    // TODO: Ganti dengan URL deployment Google Apps Script Anda!
    // Format: https://script.google.com/macros/d/YOUR_DEPLOYMENT_ID/userweb
    const googleSheetUrl = "YOUR_GOOGLE_SHEET_URL_HERE";
    
    // Jika belum di-setup, skip
    if (googleSheetUrl === "YOUR_GOOGLE_SHEET_URL_HERE") {
